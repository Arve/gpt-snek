(function () {
    ...
    const gameConfig = {
        ...
        fps: 15, // configured by a human to make the game actually playable
    ...
    class Snake {
        ...
        constructor() {
            ...
            // Set the initial desired velocity of the snake
        ...
        update() {
            // Validate the new direction of the snake
            if (this.validateDirection()) {
                // Set the snake's velocity to the desired velocity if it is valid
        ...
        validateDirection() {
            // Return false if the desired direction is opposite to the current direction in the x direction
            if (this.velocity.x !== 0 && this.desiredVelocity.x !== 0 && this.velocity.x !== this.desiredVelocity.x) {
              return false;
            }
          
            // Return false if the desired direction is opposite to the current direction in the y direction
            if (this.velocity.y !== 0 && this.desiredVelocity.y !== 0 && this.velocity.y !== this.desiredVelocity.y) {
              return false;
            }
          
            // Return true if the desired direction is not opposite to the current direction in the x or y direction
            return true;
        }
    ...
    function handleKeyboardEvent(event) {
        ...
        switch (event.key) {
            case "ArrowUp":
                // Update the snake's desired velocity to move upwards
                snake.desiredVelocity.x = 0;
                snake.desiredVelocity.y = -1;
                break;
            case "ArrowDown":
                // Update the snake's desired velocity to move downwards
                snake.desiredVelocity.x = 0;
                snake.desiredVelocity.y = 1;
                break;
            case "ArrowLeft":
                // Update the snake's desired velocity to move to the left
                snake.desiredVelocity.x = -1;
                snake.desiredVelocity.y = 0;
                break;
            case "ArrowRight":
                // Update the snake's desired velocity to move to the right
                snake.desiredVelocity.x = 1;
                snake.desiredVelocity.y = 0;
                break;
            case " ":
